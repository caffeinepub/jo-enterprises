...
import type { ContactInquiry as _ContactInquiry, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getInquiry(arg0: string, arg1: string): Promise<ContactInquiry | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getInquiry(arg0, arg1);
...
function from_candid_opt_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ContactInquiry]): ContactInquiry | null {
